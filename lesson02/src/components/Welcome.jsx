...
export default function Welcome() {
    ...
    //     ㄴ message 변수는 값을 변경하기 위해 반드시 setMessage 메소드를 사용해야 함.
    //          ㄴ useState 로 선언된 변수는 상태변수: getElementBid('').textcontent='값' 코드의 비효율성 개선
    const [message, setMessage] = useState('Welcome!!')
    const [h3Color, setH3Color] = useState('green')
    // useState(많이 쓰이고 중요한 리액트의 '훅'.상태변수의 초기값)
